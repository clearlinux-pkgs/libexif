...
Source0  : https://github.com/libexif/libexif/archive/libexif-0_6_22-release.tar.gz
...
%prep
%setup -q -n libexif-libexif-0_6_22-release
cd %{_builddir}/libexif-libexif-0_6_22-release
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589823924
...
cp %{_builddir}/libexif-libexif-0_6_22-release/COPYING %{buildroot}/usr/share/package-licenses/libexif/4df5d4b947cf4e63e675729dd3f168ba844483c7
%make_install
